# Form implementation generated from reading ui file 'designer\remove_task_dialog.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("designer\\../icons/minus.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
